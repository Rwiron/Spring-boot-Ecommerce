...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Employee portfolia</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					...
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="log-out">Logout</a></li>
						
							
						<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="log-out"><%=session.getAttribute("name") %></a></li>
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To our Group Portfolia</h1>
			<!-- Icon Divider-->
			...
			<p class="masthead-subheading font-weight-light mb-0">Java
				JSP&SERVLET - Dynamic website -In Java </p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">this is group 16 with all latest portfolia we want to fill all
					latest information about the final exam we did we try our best but our website is 
					still develeped becouse the of time  .</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">
					we make employee blog site  in java using java jsp and servelet where 
					employee will be able to access all latest information available throught
					online but before accessing he/she will first register then login in 
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Unilak <br /> Aline&Kanyana group 16
					</p>
				</div>
				<!-- Footer Social Icons-->
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About our group</h4>
					<p class="lead mb-0">
						this is group presentation 16 portfolia on Employee blogs
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Employee blogs Unilak Group16</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
